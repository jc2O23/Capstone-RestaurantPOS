...
class AdminLogin: 
    def __init__(self):
        ...
        self.admin_button = ttk.Button(self.signin, text="Admin Log-In", command=self.admin_logIn)
...
class mainWindow:
    def __init__(self, name):
        ...
        self.menu_button = tk.Button(self.top_frame, image=self.menu_image, width=75, height=75, text="Menu Setup", compound='top', padx=10, pady=10, font='bold')
        self.menu_button.pack(padx=10, pady=5, side='left')

        self.employee_image = PhotoImage(file="./images/red_employee_favicon_64x64.png")
        self.employee_button = tk.Button(self.top_frame, image=self.employee_image, width=75, height=75, text="Employees", compound='top', padx=10, pady=10, font='bold')
